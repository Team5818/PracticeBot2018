...
import org.usfirst.frc.team5818.robot.commands.DriveForward;
...
public class Robot extends IterativeRobot {
	...
	public void autonomousInit() {
		new DriveForward(5 * 12, 0.4).start();
	}
	...
	public void teleopPeriodic() {
		...
		/*
		 * if(shoot_joy_read && !shoot_act) { shoot_act = true; } else
		 * if(shoot_joy_read && shoot_act) { shoot_act = false; }
		 */
